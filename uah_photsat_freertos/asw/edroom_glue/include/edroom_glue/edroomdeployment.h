...
//Signal Conversion
	...
	static TEDROOMSignal C5ObsMng_PObsManager__C4TCManager_PObsManager(TEDROOMSignal signal);
	static TEDROOMSignal C4TCManager_PObsManager__C5ObsMng_PObsManager(TEDROOMSignal signal);
