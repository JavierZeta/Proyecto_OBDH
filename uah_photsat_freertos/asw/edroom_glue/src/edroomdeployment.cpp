...
TEDROOMSignal CEDROOMSystemCommSAP::C5ObsMng_PObsManager__C4TCManager_PObsManager(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C4TCManager_PObsManager__C5ObsMng_PObsManager(TEDROOMSignal signalOut){
...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp4->ObsManager, mp_comp4);
	...
	m_localCommSAP.RegisterInterface(1, mp_comp5->ObsManager, mp_comp5);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp5->ObsManager, mp_comp4->ObsManager, connections[0], 
					C5ObsMng_PObsManager__C4TCManager_PObsManager, 
					C4TCManager_PObsManager__C5ObsMng_PObsManager);
