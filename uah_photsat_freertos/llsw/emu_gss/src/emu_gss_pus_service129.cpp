...
EmuGSS_TCProgram129_1::EmuGSS_TCProgram129_1(uint32_t uniTime2YK,
	...
	//TODO 07 complete EmuGSS_TCProgram129_1 constructor
	mThetaYaw=ThetaYaw;
...
void EmuGSS_TCProgram129_1::BuildTCAppData(tc_mem_descriptor_t &tc_descriptor){
	...
	//TODO 06 complete EmuGSS_TCProgram129_1::BuildTCAppData code
...
EmuGSS_TCProgram129_2::EmuGSS_TCProgram129_2(uint32_t uniTime2YK,
	...
	//TODO  09complete EmuGSS_TCProgram129_2 constructor
	mKp=Kp;
	mKi=Ki;
	mKd=Kd;
...
void EmuGSS_TCProgram129_2::BuildTCAppData(tc_mem_descriptor_t &tc_descriptor){
	...
	//TODO 08 complete EmuGSS_TCProgram129_2::BuildTCAppData code
	SetNextFloat(mKp);
	SetNextFloat(mKi);
	SetNextFloat(mKd);
